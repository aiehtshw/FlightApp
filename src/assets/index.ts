...
export const PlaneCardIcon = require('./src/plane-card.svg').default;
export const PlusIcon = require('./src/plus.svg').default;
export const TakeOffIcon = require('./src/take-off.svg').default;
export const TurkishAirlinesIcon =
  require('./src/turkish-airlines.svg').default;
